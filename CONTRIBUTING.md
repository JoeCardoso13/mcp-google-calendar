...
1. **Add response models** to `src/mcp_google_calendar/api_models.py`
2. **Add client methods** to `src/mcp_google_calendar/api_client.py`
3. **Add the tool** to `src/mcp_google_calendar/server.py` using `@mcp.tool()`
